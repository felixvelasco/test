 ...
 * 
 */
@WebServiceClient(name = "Services", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://com.isb.trxYPagos.wsdl.Services/Services.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICES_QNAME = new QName("http://tempuri.org/", "Services");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://com.isb.trxYPagos.wsdl.Services/Services.wsdl");
    ...
    public ServicesSoap getServicesSoap() {
        return super.getPort(new QName("http://tempuri.org/", "ServicesSoap"), ServicesSoap.class);
    }
    ...
    public ServicesSoap getServicesSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "ServicesSoap"), ServicesSoap.class, features);
    }
