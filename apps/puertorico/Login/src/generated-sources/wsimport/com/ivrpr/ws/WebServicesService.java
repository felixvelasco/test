 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://ws.ivrpr.com/", wsdlLocation = "http://com.isb.login.wsdl.WebServicesService/WebServicesService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESSERVICE_QNAME = new QName("http://ws.ivrpr.com/", "WebServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://com.isb.login.wsdl.WebServicesService/WebServicesService.wsdl");
    ...
    public WebServices getWebServicesPort() {
        return super.getPort(new QName("http://ws.ivrpr.com/", "WebServicesPort"), WebServices.class);
    }
    ...
    public WebServices getWebServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ivrpr.com/", "WebServicesPort"), WebServices.class, features);
    }
