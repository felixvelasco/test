 ...
 * 2014-02-06T17:05:52.976+01:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "Services", 
                  wsdlLocation = "http://localhost/wsdl/Services.wsdl",
...
public class Services extends Service {
    ...
    public final static QName ServicesSoap12 = new QName("http://tempuri.org/", "ServicesSoap12");
    public final static QName ServicesSoap = new QName("http://tempuri.org/", "ServicesSoap");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost/wsdl/Services.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Services.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost/wsdl/Services.wsdl");
        }
        WSDL_LOCATION = url;
    }
