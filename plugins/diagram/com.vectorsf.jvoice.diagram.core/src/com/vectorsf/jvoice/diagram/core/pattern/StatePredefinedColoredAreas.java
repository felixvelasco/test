...
public class StatePredefinedColoredAreas extends PredefinedColoredAreas {
	/**
	...
	private static GradientColoredAreas getRedWhiteDefaultAreas() {
		...
		addGradientColoredArea(
				gcas,
				"F8D4E7", 0, LocationType.LOCATION_TYPE_ABSOLUTE_START, "FCFAFB", 0, //$NON-NLS-1$ //$NON-NLS-2$
	...
	private static GradientColoredAreas getRedWhitePrimarySelectedAreas() {
		...
		addGradientColoredArea(
				gcas,
				"EA81B9", 0, LocationType.LOCATION_TYPE_ABSOLUTE_START, "F2AAD0", 0, //$NON-NLS-1$ //$NON-NLS-2$
				LocationType.LOCATION_TYPE_ABSOLUTE_END);
		return gradientColoredAreas;
	}
	...
	private static GradientColoredAreas getRedWhiteSecondarySelectedAreas() {
		...
		addGradientColoredArea(
				gcas,
				"F7BBDA", 0, LocationType.LOCATION_TYPE_ABSOLUTE_START, "F7C5E0", 0, //$NON-NLS-1$ //$NON-NLS-2$
				LocationType.LOCATION_TYPE_ABSOLUTE_END);
		return gradientColoredAreas;
	}
	...
	private static GradientColoredAreas getGreenWhiteDefaultAreas() {
		...
		addGradientColoredArea(
				gcas,
				"E7F8D4", 0, LocationType.LOCATION_TYPE_ABSOLUTE_START, "FBFCFA", 0, //$NON-NLS-1$ //$NON-NLS-2$
				LocationType.LOCATION_TYPE_ABSOLUTE_END);
		return gradientColoredAreas;
	}
	...
	private static GradientColoredAreas getGreenWhitePrimarySelectedAreas() {
		...
		addGradientColoredArea(
				gcas,
				"B9EA81", 0, LocationType.LOCATION_TYPE_ABSOLUTE_START, "D0F2AA", 0, //$NON-NLS-1$ //$NON-NLS-2$
				LocationType.LOCATION_TYPE_ABSOLUTE_END);
		return gradientColoredAreas;
	}
	...
	private static GradientColoredAreas getGreenWhiteSecondarySelectedAreas() {
		...
		addGradientColoredArea(
				gcas,
				"DAF7BB", 0, LocationType.LOCATION_TYPE_ABSOLUTE_START, "E0F7C5", 0, //$NON-NLS-1$ //$NON-NLS-2$
				LocationType.LOCATION_TYPE_ABSOLUTE_END);
		return gradientColoredAreas;
	}
}
