...
public class Messages extends NLS {
	...
	public static String AddMoreEventFeature_name;
	public static String AddMoreEventFeature_newEvent;
	public static String AddMoreEventFeature_selectName;
	public static String AddMoreEventFeature_addCustomEvent;
	static {
