...
public class InitialStatePredefinedColoredAreas extends PredefinedColoredAreas {
	/**
	...
	/**
	 * @return {@link AdaptedGradientColoredAreas} color-areas for {@link #RED_WHITE_ID} with the adaptations:
	...
	//
	/**
	 * The color-areas, which are used for default elements with the ID {@link #RED_WHITE_ID}.
	 */
	...
	/**
	 * The color-areas, which are used for primary selected elements with the ID {@link #RED_WHITE_ID}.
	 */
	...
	/**
	 * The color-areas, which are used for secondary selected elements with the ID {@link #RED_WHITE_ID}.
	 */
	...
	//
	/**
	 * @return {@link AdaptedGradientColoredAreas} color-areas for {@link #GREEN_WHITE_ID} with the adaptations:
	 *         {@link #STYLE_ADAPTATION_DEFAULT}, {@link #STYLE_ADAPTATION_PRIMARY_SELECTED},
	 *         {@link #STYLE_ADAPTATION_SECONDARY_SELECTED}.
	 */
	...
	/**
	 * The color-areas, which are used for default elements with the ID {@link #GREEN_WHITE_ID}.
	 */
	...
	/**
	 * The color-areas, which are used for primary selected elements with the ID {@link #GREEN_WHITE_ID}.
	 */
	...
	/**
	 * The color-areas, which are used for secondary selected elements with the ID {@link #GREEN_WHITE_ID}.
	 */
