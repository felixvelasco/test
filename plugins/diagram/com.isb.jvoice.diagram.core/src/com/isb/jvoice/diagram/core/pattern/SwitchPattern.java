...
public class SwitchPattern extends IdPattern {
	...
	private static final String ID_CASE_POLIGON = ID_SWITCH_PREFIX + "casePolygon";
	...
	protected PictogramElement doAdd(IAddContext context) {
		...
		setId(endPoint, ID_CASE_POLIGON);
		setIndex(endPoint, 0);
	...
	protected boolean layout(IdLayoutContext context, String id) {
		...
		if (id.equals(ID_CASE_POLIGON)) {
			GraphicsAlgorithm ga = context.getGraphicsAlgorithm();
			System.out.println(getIndex(ga));
			Graphiti.getGaService().setLocationAndSize(ga, outerRectangle.getWidth() / 2 - 20,
					outerRectangle.getHeight() - 40, 40, 40);
		}
