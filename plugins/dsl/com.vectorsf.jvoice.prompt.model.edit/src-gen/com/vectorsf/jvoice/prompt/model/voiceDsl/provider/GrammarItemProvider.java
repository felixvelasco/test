...
/**
 * This is the item provider adapter for a {@link com.vectorsf.jvoice.prompt.model.voiceDsl.Grammar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addExprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grammar_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grammar_expr_feature", "_UI_Grammar_type"),
				 VoiceDslPackage.Literals.GRAMMAR__EXPR,
				 true,
				 false,
				 false,
