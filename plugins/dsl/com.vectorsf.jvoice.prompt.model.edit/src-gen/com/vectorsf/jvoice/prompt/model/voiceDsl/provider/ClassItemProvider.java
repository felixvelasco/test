...
/**
 * This is the item provider adapter for a {@link com.vectorsf.jvoice.prompt.model.voiceDsl.Class} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VoiceDslPackage.Literals.CLASS__ABSTRACT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VoiceDslPackage.Literals.CLASS__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VoiceDslPackage.Literals.CLASS__ANNOTATION_INFO);
			childrenFeatures.add(VoiceDslPackage.Literals.CLASS__TYPE_PARAMETERS);
			childrenFeatures.add(VoiceDslPackage.Literals.CLASS__EXTENDS);
			childrenFeatures.add(VoiceDslPackage.Literals.CLASS__IMPLEMENTS);
			childrenFeatures.add(VoiceDslPackage.Literals.CLASS__MEMBERS);
		}
	...
	public String getText(Object object) {
		String label = ((com.vectorsf.jvoice.prompt.model.voiceDsl.Class)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(com.vectorsf.jvoice.prompt.model.voiceDsl.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VoiceDslPackage.Literals.CLASS__ANNOTATION_INFO,
		...
		newChildDescriptors.add
			(createChildParameter
				(VoiceDslPackage.Literals.CLASS__TYPE_PARAMETERS,
				 TypesFactory.eINSTANCE.createJvmTypeParameter()));

		newChildDescriptors.add
			(createChildParameter
				(VoiceDslPackage.Literals.CLASS__EXTENDS,
				 TypesFactory.eINSTANCE.createJvmParameterizedTypeReference()));

		newChildDescriptors.add
			(createChildParameter
				(VoiceDslPackage.Literals.CLASS__IMPLEMENTS,
				 TypesFactory.eINSTANCE.createJvmParameterizedTypeReference()));

		newChildDescriptors.add
			(createChildParameter
				(VoiceDslPackage.Literals.CLASS__MEMBERS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == VoiceDslPackage.Literals.CLASS__EXTENDS ||
			childFeature == VoiceDslPackage.Literals.CLASS__IMPLEMENTS;
