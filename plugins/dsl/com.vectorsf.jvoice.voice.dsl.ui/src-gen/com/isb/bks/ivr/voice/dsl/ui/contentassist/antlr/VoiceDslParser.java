		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMemberAccess().getGroup_2_0_1(), "rule__Member__Group_2_0_1__0");
					...
					put(grammarAccess.getMemberAccess().getGroup_2_1_1_1_0(), "rule__Member__Group_2_1_1_1_0__0");
					...
					put(grammarAccess.getInputDslAccess().getPropertiesAssignment_2_2(), "rule__InputDsl__PropertiesAssignment_2_2");
					put(grammarAccess.getInputDslAccess().getVariablesAssignment_2_3(), "rule__InputDsl__VariablesAssignment_2_3");
					put(grammarAccess.getInputDslAccess().getConditionsAssignment_2_4(), "rule__InputDsl__ConditionsAssignment_2_4");
					...
					put(grammarAccess.getRecordDslAccess().getPropertiesAssignment_4_1(), "rule__RecordDsl__PropertiesAssignment_4_1");
					put(grammarAccess.getRecordDslAccess().getVariablesAssignment_4_2(), "rule__RecordDsl__VariablesAssignment_4_2");
					put(grammarAccess.getRecordDslAccess().getConditionsAssignment_4_3(), "rule__RecordDsl__ConditionsAssignment_4_3");
					put(grammarAccess.getRecordDslAccess().getAudiosAssignment_5(), "rule__RecordDsl__AudiosAssignment_5");
					put(grammarAccess.getTransferDslAccess().getNameAssignment_1(), "rule__TransferDsl__NameAssignment_1");
					put(grammarAccess.getTransferDslAccess().getTypeTransferAssignment_3(), "rule__TransferDsl__TypeTransferAssignment_3");
					...
					put(grammarAccess.getTransferDslAccess().getPropertiesAssignment_5_0(), "rule__TransferDsl__PropertiesAssignment_5_0");
					put(grammarAccess.getTransferDslAccess().getVariablesAssignment_5_1(), "rule__TransferDsl__VariablesAssignment_5_1");
					put(grammarAccess.getTransferDslAccess().getConditionsAssignment_5_2(), "rule__TransferDsl__ConditionsAssignment_5_2");
					put(grammarAccess.getTransferDslAccess().getAudiosAssignment_6(), "rule__TransferDsl__AudiosAssignment_6");
					put(grammarAccess.getVariablesAccess().getVariableAssignment_3(), "rule__Variables__VariableAssignment_3");
					put(grammarAccess.getVariableAccess().getNameAssignment_0(), "rule__Variable__NameAssignment_0");
					put(grammarAccess.getVariableAccess().getExternalVarAssignment_2(), "rule__Variable__ExternalVarAssignment_2");
					put(grammarAccess.getVariableAccess().getMethodAssignment_4(), "rule__Variable__MethodAssignment_4");
					...
					put(grammarAccess.getAudiosAccess().getNoInputAudiosAssignment_3_0_2(), "rule__Audios__NoInputAudiosAssignment_3_0_2");
					put(grammarAccess.getConfigurationAccess().getConfigValueAssignment_3(), "rule__Configuration__ConfigValueAssignment_3");
					...
					put(grammarAccess.getMemberAccess().getTypeAssignment_2_0_1_0(), "rule__Member__TypeAssignment_2_0_1_0");
					put(grammarAccess.getMemberAccess().getNameAssignment_2_0_1_1(), "rule__Member__NameAssignment_2_0_1_1");
					put(grammarAccess.getMemberAccess().getInitialValueAssignment_2_0_2_1(), "rule__Member__InitialValueAssignment_2_0_2_1");
					put(grammarAccess.getMemberAccess().getReturnTypeAssignment_2_1_1_1_0_0(), "rule__Member__ReturnTypeAssignment_2_1_1_1_0_0");
					put(grammarAccess.getMemberAccess().getNameAssignment_2_1_1_1_0_1(), "rule__Member__NameAssignment_2_1_1_1_0_1");
					put(grammarAccess.getMemberAccess().getExpressionAssignment_2_1_2(), "rule__Member__ExpressionAssignment_2_1_2");
					...
					put(grammarAccess.getTransferDslAccess().getUnorderedGroup_5(), "rule__TransferDsl__UnorderedGroup_5");
