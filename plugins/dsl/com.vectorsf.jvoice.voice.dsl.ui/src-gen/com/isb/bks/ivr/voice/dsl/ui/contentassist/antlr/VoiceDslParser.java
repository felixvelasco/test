		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVoiceDslAccess().getGroup_0(), "rule__VoiceDsl__Group_0__0");
					put(grammarAccess.getVoiceDslAccess().getGroup_1(), "rule__VoiceDsl__Group_1__0");
					put(grammarAccess.getVoiceDslAccess().getGroup_2(), "rule__VoiceDsl__Group_2__0");
					...
					put(grammarAccess.getVoiceDslAccess().getPropertiesAssignment_0_2_2(), "rule__VoiceDsl__PropertiesAssignment_0_2_2");
					...
					put(grammarAccess.getVoiceDslAccess().getPropertiesAssignment_2_2_2(), "rule__VoiceDsl__PropertiesAssignment_2_2_2");
					put(grammarAccess.getVoiceDslAccess().getVariablesAssignment_2_2_3(), "rule__VoiceDsl__VariablesAssignment_2_2_3");
					put(grammarAccess.getVoiceDslAccess().getConditionsAssignment_2_2_4(), "rule__VoiceDsl__ConditionsAssignment_2_2_4");
					put(grammarAccess.getVoiceDslAccess().getOutputsAssignment_2_3(), "rule__VoiceDsl__OutputsAssignment_2_3");
					put(grammarAccess.getVoiceDslAccess().getTypesAssignment_3(), "rule__VoiceDsl__TypesAssignment_3");
					...
					put(grammarAccess.getVoiceDslAccess().getUnorderedGroup_0_2(), "rule__VoiceDsl__UnorderedGroup_0_2");
					put(grammarAccess.getVoiceDslAccess().getUnorderedGroup_1_2(), "rule__VoiceDsl__UnorderedGroup_1_2");
					put(grammarAccess.getVoiceDslAccess().getUnorderedGroup_2_2(), "rule__VoiceDsl__UnorderedGroup_2_2");
