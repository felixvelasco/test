 ...
 * generated by Xtext
 */
package com.isb.bks.ivr.voice.dsl.formatting;
...
public class VoiceDslFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private VoiceDslGrammarAccess _voiceDslGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._voiceDslGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._voiceDslGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._voiceDslGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._voiceDslGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._voiceDslGrammarAccess.getML_COMMENTRule();
