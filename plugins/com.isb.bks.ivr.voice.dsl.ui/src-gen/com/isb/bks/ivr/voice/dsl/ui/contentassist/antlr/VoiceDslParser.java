		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInputElementAccess().getGroup_2_0(), "rule__InputElement__Group_2_0__0");
					put(grammarAccess.getInputElementAccess().getGroup_2_1(), "rule__InputElement__Group_2_1__0");
					put(grammarAccess.getInputElementAccess().getGroup_2_2(), "rule__InputElement__Group_2_2__0");
					put(grammarAccess.getInputElementAccess().getGroup_7_0(), "rule__InputElement__Group_7_0__0");
					put(grammarAccess.getInputElementAccess().getGroup_7_1(), "rule__InputElement__Group_7_1__0");
					put(grammarAccess.getInputElementAccess().getGroup_7_2(), "rule__InputElement__Group_7_2__0");
					...
					put(grammarAccess.getConditionalAudioAccess().getGroup_1(), "rule__ConditionalAudio__Group_1__0");
					put(grammarAccess.getConditionalAudioAccess().getGroup_3(), "rule__ConditionalAudio__Group_3__0");
					put(grammarAccess.getConditionalAudioAccess().getGroup_3_3(), "rule__ConditionalAudio__Group_3_3__0");
					...
					put(grammarAccess.getInputElementAccess().getNameAssignment_1(), "rule__InputElement__NameAssignment_1");
					put(grammarAccess.getInputElementAccess().getMaxNoInputAssignment_2_0_1(), "rule__InputElement__MaxNoInputAssignment_2_0_1");
					put(grammarAccess.getInputElementAccess().getMaxNoMatchAssignment_2_1_1(), "rule__InputElement__MaxNoMatchAssignment_2_1_1");
					put(grammarAccess.getInputElementAccess().getMaxAttemptsAssignment_2_2_1(), "rule__InputElement__MaxAttemptsAssignment_2_2_1");
					put(grammarAccess.getInputElementAccess().getGrammaticsAssignment_3(), "rule__InputElement__GrammaticsAssignment_3");
					put(grammarAccess.getInputElementAccess().getConditionsAssignment_4(), "rule__InputElement__ConditionsAssignment_4");
					put(grammarAccess.getInputElementAccess().getInitialAudiosAssignment_7_0_2(), "rule__InputElement__InitialAudiosAssignment_7_0_2");
					put(grammarAccess.getInputElementAccess().getNoMatchAudiosAssignment_7_1_2(), "rule__InputElement__NoMatchAudiosAssignment_7_1_2");
					put(grammarAccess.getInputElementAccess().getNoInputAudiosAssignment_7_2_2(), "rule__InputElement__NoInputAudiosAssignment_7_2_2");
					put(grammarAccess.getGrammarAccess().getModeAssignment_1(), "rule__Grammar__ModeAssignment_1");
					put(grammarAccess.getGrammarAccess().getExprAssignment_2(), "rule__Grammar__ExprAssignment_2");
					...
					put(grammarAccess.getConditionAccess().getExpreAssignment_3(), "rule__Condition__ExpreAssignment_3");
					...
					put(grammarAccess.getConditionalAudioAccess().getConditionAssignment_1_1(), "rule__ConditionalAudio__ConditionAssignment_1_1");
					put(grammarAccess.getConditionalAudioAccess().getDontBargeInAssignment_3_1(), "rule__ConditionalAudio__DontBargeInAssignment_3_1");
					put(grammarAccess.getConditionalAudioAccess().getTtsAssignment_3_2(), "rule__ConditionalAudio__TtsAssignment_3_2");
					put(grammarAccess.getConditionalAudioAccess().getSrcAssignment_3_3_1(), "rule__ConditionalAudio__SrcAssignment_3_3_1");
					...
					put(grammarAccess.getInputElementAccess().getUnorderedGroup_2(), "rule__InputElement__UnorderedGroup_2");
					put(grammarAccess.getInputElementAccess().getUnorderedGroup_7(), "rule__InputElement__UnorderedGroup_7");
				}
			};
		}
