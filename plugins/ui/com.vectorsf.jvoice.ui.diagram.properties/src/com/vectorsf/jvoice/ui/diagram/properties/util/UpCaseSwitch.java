...
public class UpCaseSwitch extends RecordingCommand {

	private SwitchState estadoSelection;
	private List<Case> casos;
	private TableViewer tableViewer;
	
	public UpCaseSwitch (TransactionalEditingDomain domain, SwitchState estadoSelection, List<Case> casos, TableViewer tableViewer){
		super(domain);
