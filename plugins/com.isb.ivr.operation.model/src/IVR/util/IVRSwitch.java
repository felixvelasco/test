 ...
 * @generated
 */
public class IVRSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IVRPackage.PROMPT: {
				Prompt prompt = (Prompt)theEObject;
				T result = casePrompt(prompt);
				if (result == null) result = caseState(prompt);
				if (result == null) result = caseFlowElement(prompt);
				if (result == null) result = caseNamedElement(prompt);
				if (result == null) result = caseElement(prompt);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IVRPackage.INPUT: {
				Input input = (Input)theEObject;
				T result = caseInput(input);
				if (result == null) result = caseState(input);
				if (result == null) result = caseFlowElement(input);
				if (result == null) result = caseNamedElement(input);
				if (result == null) result = caseElement(input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IVRPackage.MENU: {
				Menu menu = (Menu)theEObject;
				T result = caseMenu(menu);
				if (result == null) result = caseState(menu);
				if (result == null) result = caseFlowElement(menu);
				if (result == null) result = caseNamedElement(menu);
				if (result == null) result = caseElement(menu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IVRPackage.LITERAL: {
