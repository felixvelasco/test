...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.LOGICAL_PACKAGE: {
				LogicalPackage logicalPackage = (LogicalPackage)theEObject;
				T result = caseLogicalPackage(logicalPackage);
				if (result == null) result = caseNamedElement(logicalPackage);
				if (result == null) result = caseElement(logicalPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.BEAN: {
				Bean bean = (Bean)theEObject;
				T result = caseBean(bean);
				if (result == null) result = caseNamedElement(bean);
				if (result == null) result = caseElement(bean);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Logical Package</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Logical Package</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLogicalPackage(LogicalPackage object) {
		return null;
	}
