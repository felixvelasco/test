 ...
 * <ul>
 *   <li>{@link com.isb.bks.ivr.voice.dsl.voiceDsl.impl.MatchImpl#getAudio <em>Audio</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MatchImpl extends MinimalEObjectImpl.Container implements Match
{
  ...
  {
    return VoiceDslPackage.Literals.MATCH;
  }
  ...
  public EList<Audio> getAudio()
  {
    if (audio == null)
    {
      audio = new EObjectContainmentEList<Audio>(Audio.class, this, VoiceDslPackage.MATCH__AUDIO);
    }
    return audio;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VoiceDslPackage.MATCH__AUDIO:
