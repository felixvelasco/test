...
public class VoiceDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new com.isb.bks.ivr.voice.dsl.VoiceDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.isb.com/bks/ivr/voice/dsl/VoiceDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.isb.com/bks/ivr/voice/dsl/VoiceDsl", com.isb.bks.ivr.voice.dsl.voiceDsl.VoiceDslPackage.eINSTANCE);
	}
