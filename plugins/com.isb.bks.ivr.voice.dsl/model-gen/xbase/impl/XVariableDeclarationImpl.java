...
public class XVariableDeclarationImpl extends XExpressionImpl implements XVariableDeclaration {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == JvmIdentifiableElement.class) {
			switch (baseOperationID) {
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_IDENTIFIER: return XbasePackage.XVARIABLE_DECLARATION___GET_IDENTIFIER;
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_SIMPLE_NAME: return XbasePackage.XVARIABLE_DECLARATION___GET_SIMPLE_NAME;
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_QUALIFIED_NAME: return XbasePackage.XVARIABLE_DECLARATION___GET_QUALIFIED_NAME;
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_QUALIFIED_NAME__CHAR: return XbasePackage.XVARIABLE_DECLARATION___GET_QUALIFIED_NAME__CHAR;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XbasePackage.XVARIABLE_DECLARATION___GET_IDENTIFIER:
				return getIdentifier();
			case XbasePackage.XVARIABLE_DECLARATION___GET_SIMPLE_NAME:
				return getSimpleName();
			case XbasePackage.XVARIABLE_DECLARATION___GET_QUALIFIED_NAME:
				return getQualifiedName();
			case XbasePackage.XVARIABLE_DECLARATION___GET_QUALIFIED_NAME__CHAR:
