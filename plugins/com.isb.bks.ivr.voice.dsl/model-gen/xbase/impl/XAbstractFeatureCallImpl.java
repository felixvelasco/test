 ...
 *   <li>{@link xbase.impl.XAbstractFeatureCallImpl#getImplicitFirstArgument <em>Implicit First Argument</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class XAbstractFeatureCallImpl extends XExpressionImpl implements XAbstractFeatureCall {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XbasePackage.XABSTRACT_FEATURE_CALL___GET_CONCRETE_SYNTAX_FEATURE_NAME:
				return getConcreteSyntaxFeatureName();
			case XbasePackage.XABSTRACT_FEATURE_CALL___GET_EXPLICIT_ARGUMENTS:
				return getExplicitArguments();
			case XbasePackage.XABSTRACT_FEATURE_CALL___IS_EXPLICIT_OPERATION_CALL_OR_BUILDER_SYNTAX:
				return isExplicitOperationCallOrBuilderSyntax();
			case XbasePackage.XABSTRACT_FEATURE_CALL___GET_ACTUAL_RECEIVER:
				return getActualReceiver();
			case XbasePackage.XABSTRACT_FEATURE_CALL___GET_ACTUAL_ARGUMENTS:
				return getActualArguments();
			case XbasePackage.XABSTRACT_FEATURE_CALL___IS_STATIC:
				return isStatic();
			case XbasePackage.XABSTRACT_FEATURE_CALL___IS_EXTENSION:
				return isExtension();
			case XbasePackage.XABSTRACT_FEATURE_CALL___IS_PACKAGE_FRAGMENT:
				return isPackageFragment();
			case XbasePackage.XABSTRACT_FEATURE_CALL___IS_TYPE_LITERAL:
