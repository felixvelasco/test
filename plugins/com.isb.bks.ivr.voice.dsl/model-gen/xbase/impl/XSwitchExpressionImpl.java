 ...
 * <ul>
 *   <li>{@link xbase.impl.XSwitchExpressionImpl#getSwitch <em>Switch</em>}</li>
 *   <li>{@link xbase.impl.XSwitchExpressionImpl#getCases <em>Cases</em>}</li>
 *   <li>{@link xbase.impl.XSwitchExpressionImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link xbase.impl.XSwitchExpressionImpl#getLocalVarName <em>Local Var Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XSwitchExpressionImpl extends XExpressionImpl implements XSwitchExpression {
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == JvmIdentifiableElement.class) {
			switch (baseOperationID) {
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_IDENTIFIER: return XbasePackage.XSWITCH_EXPRESSION___GET_IDENTIFIER;
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_SIMPLE_NAME: return XbasePackage.XSWITCH_EXPRESSION___GET_SIMPLE_NAME;
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_QUALIFIED_NAME: return XbasePackage.XSWITCH_EXPRESSION___GET_QUALIFIED_NAME;
				case TypesPackage.JVM_IDENTIFIABLE_ELEMENT___GET_QUALIFIED_NAME__CHAR: return XbasePackage.XSWITCH_EXPRESSION___GET_QUALIFIED_NAME__CHAR;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XbasePackage.XSWITCH_EXPRESSION___GET_IDENTIFIER:
				return getIdentifier();
			case XbasePackage.XSWITCH_EXPRESSION___GET_SIMPLE_NAME:
				return getSimpleName();
			case XbasePackage.XSWITCH_EXPRESSION___GET_QUALIFIED_NAME:
				return getQualifiedName();
			case XbasePackage.XSWITCH_EXPRESSION___GET_QUALIFIED_NAME__CHAR:
