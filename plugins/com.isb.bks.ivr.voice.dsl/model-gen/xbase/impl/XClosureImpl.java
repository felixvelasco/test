 ...
 * <ul>
 *   <li>{@link xbase.impl.XClosureImpl#getDeclaredFormalParameters <em>Declared Formal Parameters</em>}</li>
 *   <li>{@link xbase.impl.XClosureImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link xbase.impl.XClosureImpl#isExplicitSyntax <em>Explicit Syntax</em>}</li>
 *   <li>{@link xbase.impl.XClosureImpl#getImplicitParameter <em>Implicit Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XClosureImpl extends XExpressionImpl implements XClosure {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case XbasePackage.XCLOSURE___GET_FORMAL_PARAMETERS:
