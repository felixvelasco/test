 ...
 * <ul>
 *   <li>{@link voiceDsl.impl.ConditionalAudioImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalAudioImpl extends AudioImpl implements ConditionalAudio {
		...
		if (condition != null && condition.eIsProxy()) {
			...
			if (condition != oldCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VoiceDslPackage.CONDITIONAL_AUDIO__CONDITION, oldCondition, condition));
			}
		}
		return condition;
	}
	...
	public void setCondition(Condition newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VoiceDslPackage.CONDITIONAL_AUDIO__CONDITION, oldCondition, condition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VoiceDslPackage.CONDITIONAL_AUDIO__CONDITION:
