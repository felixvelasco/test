 ...
 * <ul>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#getArrayType <em>Array Type</em>}</li>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#getSuperTypes <em>Super Types</em>}</li>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#getMembers <em>Members</em>}</li>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link types.impl.JvmDeclaredTypeImpl#getPackageName <em>Package Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class JvmDeclaredTypeImpl extends JvmMemberImpl implements JvmDeclaredType {
	/**
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TypesPackage.JVM_DECLARED_TYPE___GET_DECLARED_OPERATIONS:
				return getDeclaredOperations();
			case TypesPackage.JVM_DECLARED_TYPE___GET_DECLARED_FIELDS:
				return getDeclaredFields();
			case TypesPackage.JVM_DECLARED_TYPE___FIND_ALL_FEATURES_BY_NAME__STRING:
				return findAllFeaturesByName((String)arguments.get(0));
			case TypesPackage.JVM_DECLARED_TYPE___GET_ALL_FEATURES:
