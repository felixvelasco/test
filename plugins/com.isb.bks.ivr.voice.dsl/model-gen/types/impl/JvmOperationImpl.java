 ...
 * <ul>
 *   <li>{@link types.impl.JvmOperationImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#isFinal <em>Final</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#getReturnType <em>Return Type</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#isSynchronized <em>Synchronized</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#isDefault <em>Default</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#isNative <em>Native</em>}</li>
 *   <li>{@link types.impl.JvmOperationImpl#isStrictFloatingPoint <em>Strict Floating Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
