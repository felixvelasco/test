 ...
 * <ul>
 *   <li>{@link types.impl.JvmTypeConstraintImpl#getTypeReference <em>Type Reference</em>}</li>
 *   <li>{@link types.impl.JvmTypeConstraintImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class JvmTypeConstraintImpl extends MinimalEObjectImpl.Container implements JvmTypeConstraint {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TypesPackage.JVM_TYPE_CONSTRAINT___GET_IDENTIFIER:
				return getIdentifier();
			case TypesPackage.JVM_TYPE_CONSTRAINT___GET_SIMPLE_NAME:
				return getSimpleName();
			case TypesPackage.JVM_TYPE_CONSTRAINT___GET_QUALIFIED_NAME:
				return getQualifiedName();
			case TypesPackage.JVM_TYPE_CONSTRAINT___GET_QUALIFIED_NAME__CHAR:
