 ...
 * <ul>
 *   <li>{@link types.impl.JvmParameterizedTypeReferenceImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link types.impl.JvmParameterizedTypeReferenceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JvmParameterizedTypeReferenceImpl extends JvmTypeReferenceImpl implements JvmParameterizedTypeReference {
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.JVM_PARAMETERIZED_TYPE_REFERENCE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.JVM_PARAMETERIZED_TYPE_REFERENCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(JvmType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.JVM_PARAMETERIZED_TYPE_REFERENCE__TYPE, oldType, type));
	}
