 ...
 * </p>
 *
 * @see types.TypesPackage#getJvmTypeParameter()
 * @model
 * @generated
 */
public interface JvmTypeParameter extends EObject, JvmComponentType, JvmConstraintOwner {
	/**
	 ...
	 * @see #setName(String)
	 * @see types.TypesPackage#getJvmTypeParameter_Name()
	 * @model
	 * @generated
	 */
	String getName();
	 ...
	 * @see types.TypesPackage#getJvmTypeParameter_Declarator()
	 * @see org.eclipse.xtext.common.types.JvmTypeParameterDeclarator#getTypeParameters
	 * @model opposite="typeParameters" resolveProxies="false" transient="false"
	 * @generated
	 */
