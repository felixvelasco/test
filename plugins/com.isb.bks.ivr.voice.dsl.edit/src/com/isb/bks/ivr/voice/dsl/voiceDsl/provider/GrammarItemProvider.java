...
/**
 * This is the item provider adapter for a {@link com.isb.bks.ivr.voice.dsl.voiceDsl.Grammar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GrammarItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VoiceDslPackage.Literals.GRAMMAR__MODE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Builtin feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBuiltinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grammar_builtin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grammar_builtin_feature", "_UI_Grammar_type"),
				 VoiceDslPackage.Literals.GRAMMAR__BUILTIN,
				 true,
				 false,
				 false,
	...
	protected void addSrcPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Grammar_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Grammar_src_feature", "_UI_Grammar_type"),
				 VoiceDslPackage.Literals.GRAMMAR__SRC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Grammar)object).getMode();
