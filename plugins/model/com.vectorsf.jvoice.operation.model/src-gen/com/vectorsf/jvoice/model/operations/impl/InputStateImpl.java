 ...
 * <ul>
 *   <li>{@link com.vectorsf.jvoice.model.operations.impl.InputStateImpl#getLocution <em>Locution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InputStateImpl extends StateImpl implements InputState {
	/**
		...
		if (locution != null && locution.eIsProxy()) {
			...
			if (locution != oldLocution) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OperationsPackage.INPUT_STATE__LOCUTION, oldLocution, locution));
			}
		}
		return locution;
	}
	...
	public void setLocution(VoiceDsl newLocution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationsPackage.INPUT_STATE__LOCUTION, oldLocution, locution));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationsPackage.INPUT_STATE__LOCUTION:
