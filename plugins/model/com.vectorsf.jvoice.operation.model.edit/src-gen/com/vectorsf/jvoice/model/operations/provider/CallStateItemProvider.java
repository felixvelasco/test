...
/**
 * This is the item provider adapter for a {@link com.vectorsf.jvoice.model.operations.CallState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CallStateItemProvider
	 ...
	 * @generated
	 */
	public CallStateItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CallState_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CallState_parameters_feature", "_UI_CallState_type"),
				 OperationsPackage.Literals.CALL_STATE__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CallState"));
	}
	...
	public String getText(Object object) {
		String label = ((CallState)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CallState_type") :
			getString("_UI_CallState_type") + " " + label;
	}
