...
/**
 * This is the item provider adapter for a {@link com.vectorsf.jvoice.model.operations.FinalState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FinalState_final_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FinalState_final_feature", "_UI_FinalState_type"),
				 OperationsPackage.Literals.FINAL_STATE__FINAL,
				 true,
				 false,
				 false,
	...
	protected void addReturnExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FinalState_returnExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FinalState_returnExpression_feature", "_UI_FinalState_type"),
				 OperationsPackage.Literals.FINAL_STATE__RETURN_EXPRESSION,
				 true,
				 false,
				 false,
