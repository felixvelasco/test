...
public class BaseFactoryImpl extends EFactoryImpl implements BaseFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case BasePackage.EVENTS_ENUM:
				return createEventsEnumFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case BasePackage.EVENTS_ENUM:
				return convertEventsEnumToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public EventsEnum createEventsEnumFromString(EDataType eDataType, String initialValue) {
		EventsEnum result = EventsEnum.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertEventsEnumToString(EDataType eDataType, Object instanceValue) {
