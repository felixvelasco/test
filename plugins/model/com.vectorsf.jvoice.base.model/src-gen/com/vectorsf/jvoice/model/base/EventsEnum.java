...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Events Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.vectorsf.jvoice.model.base.BasePackage#getEventsEnum()
 * @model
 * @generated
 */
public enum EventsEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Events Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final EventsEnum[] VALUES_ARRAY =
		new EventsEnum[] {
			BUSY,
			CONNECTIONERROR,
			ERROR,
	...
	/**
	 * A public read-only list of all the '<em><b>Events Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<EventsEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Events Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static EventsEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EventsEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Events Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static EventsEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			EventsEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Events Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static EventsEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private EventsEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
